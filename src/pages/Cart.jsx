                ...
                (<div>
                    ...
                    <div className='flex flex-col md:flex-row justify-between space-x-10 mt-8'>
                                ...
                                <div key={product.id} className='flex items-center justify-between p-3 border-b'>
                                    ...
                                    <div className='flex space-x-11 items-center'>
                                        ...
                                        <div className='flex items-center justify-center border'>
                                            <button className='text-xl px-1.5 py-0.5 border-r  bg-teal-800 text-white '
                                             onClick={handleAddClick}>-</button>
                                            <p className='text-xl px-2'>{product.quantity}</p>
                                            <button className='text-xl px-1 py-0.5 border-l bg-teal-800 text-white '>+</button>
                                        </div>
                                        <p>${(product.quantity * product.price).toFixed(2)}&nbsp;&nbsp;</p>
                                        <button className='text-teal-800 hover:text-black'>
                                            <FaTrashAlt />
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                            ...
                            <button className='w-full bg-teal-800 text-white py-2 hover:bg-teal-950'>Procced to Checkout</button>
                        </div>
                    </div>
                </div>)
